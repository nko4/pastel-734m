...
~~~sh
# getting the code
git clone git@github.com:nko4/pastel-734m.git && cd ./pastel-734m/

# developing
npm install
npm start

# deploying (to http://pastel-734m.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@pastel-734m.2013.nodeknockout.com
ssh root@pastel-734m.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@pastel-734m.2013.nodeknockout.com
ssh -i ./id_deploy root@pastel-734m.2013.nodeknockout.com
~~~
